    ...
    public partial class InitialIdentityDbContext : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HotelRoomTypeNumbers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HotelRoomTypeNumbers_Hotels_HotelId",
                        column: x => x.HotelId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DrinkMachine = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ChekInTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    ChekOutTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HotelRoomTypeNumbers_HotelId",
                table: "HotelRoomTypeNumbers",
                column: "HotelId");
